...
time_text = ax1.text(20.75,0.25, '',fontsize=20)
ax1.set_xlim(0, 25)
ax1.text(20.75, 0.125, 'Created by Brian C. Jenkins',fontsize=11, color='black',alpha=0.5)
...
ax1.set_title('Transition to the Steady State from Below',fontsize=20)
...
ani.save('../video/solow_transition_from_below.mp4',writer=writer)
