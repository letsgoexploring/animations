...
ani.save('../video/signalingSeparating.mp4',writer=writer)

# # Convert the mp4 video to ogg format
# makeOgg = 'ffmpeg -i ../video/signalingSeparating.mp4 -c:v libtheora -c:a libvorbis -q:v 6 -q:a 5 ../video/signalingSeparating.ogv'
